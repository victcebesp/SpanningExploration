...
def graph_search(problem, fringe):
    ...
    while fringe:
        node = fringe.pop()
        if problem.goal_test(node.state):
            print "Expanded Nodes: " + str(fringe.expandedNodes)
            return node
...
def branch_boundary_graph_search(problem):
    return graph_search(problem, PathCostSortedStack())

def branch_boundary_graph_search_substimation(problem):
    return graph_search(problem, HeuristicStack(problem))
